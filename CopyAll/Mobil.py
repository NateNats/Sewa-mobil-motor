...
img1 = PhotoImage(file=f"sewaMobil1.png")
b1 = Button(image=img1, borderwidth=0, highlightthickness=0, command=btn_clicked,relief="flat")
b1.place(x=118, y=226, width=101, height=23)

img2 = PhotoImage(file=f"sewaMobil2.png")
b2 = Button(image=img2, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")

b2.place(x=309, y=226, width=92, height=22)

img3 = PhotoImage(file=f"sewaMobil3.png")
b3 = Button(image=img3, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b3.place(x=872, y=438, width=81, height=23)

img4 = PhotoImage(file=f"sewaMobil4.png")
b4 = Button(image=img4, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b4.place(x=685, y=438, width=81, height=23)

img5 = PhotoImage(file=f"sewaMobil5.png")
b5 = Button(image=img5, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b5.place(x=872, y=224, width=81, height=23)

img6 = PhotoImage(file=f"sewaMobil6.png")
b6 = Button(image=img6, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b6.place(x=499, y=438, width=81, height=23)

img7 = PhotoImage(file=f"sewaMobil7.png")
b7 = Button(image=img6, borderwidth=0, highlightthickness=0,command=btn_clicked, relief="flat")
b7.place(x=313, y=438, width=81, height=23)

img8 = PhotoImage(file=f"sewaMobil8.png")
b8 = Button(image=img8, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b8.place(x=125, y=438, width=81, height=23)

img9 = PhotoImage(file=f"sewamobil9.png")
b9 = Button(image=img9, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b9.place(x=685, y=226, width=90, height=23)

img10 = PhotoImage(file=f"sewaMobil10.png")
b10 = Button(image=img10, borderwidth=0, highlightthickness=0, command=btn_clicked, relief="flat")
b10.place(x=499, y=226, width=97,height=23)
